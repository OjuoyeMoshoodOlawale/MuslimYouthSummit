-- =============================================================
-- MYS PLATFORM — DATABASE SCHEMA v4 (DEFINITIVE)
-- Muslim Youth Summit Event Management System
-- Always drop and re-run this for a clean install.
-- =============================================================
...
CREATE TABLE IF NOT EXISTS events (
  ...
  ticket_prefix        VARCHAR(10)  NULL     COMMENT 'Override prefix for ticket numbers e.g. MYS3-25. NULL = use edition',
...
-- =============================================================
-- 9. PARTICIPANTS
-- NOTE: No UNIQUE on email — allows family registrations.
--       Uniqueness enforced per-ticket (unique_number) per event.
-- =============================================================
...
-- Index for fast lookup (not UNIQUE — family members can share email)
...
-- =============================================================
-- 11. HOSTELS (GLOBAL — column: beds not capacity)
-- =============================================================
...
CREATE TABLE IF NOT EXISTS event_gallery (
  ...
  google_drive_id VARCHAR(200) NULL COMMENT 'Google Drive file ID for reference',
  sort_order    SMALLINT UNSIGNED NOT NULL DEFAULT 0,
...
-- =============================================================
-- 18. EVENT SNAPSHOTS & FACILITATOR REMINDERS
-- =============================================================
