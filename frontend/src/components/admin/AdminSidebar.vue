<template>
  <aside class="fixed inset-y-0 left-0 z-40 flex flex-col bg-brand-green text-white transition-all duration-300"
...
import {
  ...
  UserPlus, BedDouble, Building2, ReceiptText, Settings, ShoppingBag, Handshake, Star,
