<template>
  <div class="min-h-screen bg-gray-50">
    ...
    <aside class="fixed top-0 left-0 h-full z-50 transition-transform duration-300 ease-out lg:transition-all"
      :class="[
        sidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0',
      ]">
      <!-- On mobile always full width (collapsed=false); on desktop respect collapse -->
      <AdminSidebar
